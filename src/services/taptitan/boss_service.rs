...
impl BossService {
    ...
    pub fn create_custom_boss(
        ...
        Boss {
            boss_name: name,
            head: BossPart::new(BossPartName::Head, PartState::Armor, default_armor, default_health, default_armor, default_health),
            torso: BossPart::new(BossPartName::Torso, PartState::Armor, default_armor, default_health, default_armor, default_health),
            left_shoulder: BossPart::new(BossPartName::LeftShoulder, PartState::Armor, default_armor, default_health, default_armor, default_health),
            right_shoulder: BossPart::new(BossPartName::RightShoulder, PartState::Armor, default_armor, default_health, default_armor, default_health),
            left_hand: BossPart::new(BossPartName::LeftHand, PartState::Armor, default_armor, default_health, default_armor, default_health),
