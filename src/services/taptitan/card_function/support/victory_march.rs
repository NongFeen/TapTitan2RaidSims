use crate::models::{boss::{Boss, PartState}, card_skill_data::{card_skill_bonusamountD, card_skill_value_a, card_skill_value_b}, cards::Card, support_modifier::SupportModifiers};
