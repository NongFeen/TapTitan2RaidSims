use crate::models::{
    boss::{Boss, BossPartName, PartState}, card_skill_data::{card_skill_bonusamountC, card_skill_value_a}, cards::Card, damage_source::DamageSource,
};
...
pub fn on_proc(
    ...
    boss.on_hit_with_source(
        target_part,
        (damage * total_mult).max(0.0).round() as u64,
