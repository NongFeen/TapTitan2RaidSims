...
#[openapi(
    ...
    paths(
        ...
        crate::routes::raid_cycle::current_attack_summary,
        crate::routes::recommendations::generate_for_player,
        crate::routes::recommendations::custom_for_player,
    ...
    components(schemas(
        ...
        crate::routes::raid_cycle::CycleAttackSummaryView,
        crate::routes::raid_cycle::CardUsageView,
        crate::routes::recommendations::GenerateRecommendationRequest,
        crate::routes::recommendations::GenerateRecommendationResponse,
        crate::routes::recommendations::CustomRecommendationRequest,
